...
export class Contract  {
  ...
  async allowance(arg0: string, arg1: string): Promise<ethers.BigNumber> {
    const result = await this.call("allowance", [arg0, arg1])
    return result[0]
  }

  async balanceOf(arg0: string): Promise<ethers.BigNumber> {
    const result = await this.call("balanceOf", [arg0])
    return result[0]
  }
  ...
  async nonces(arg0: string): Promise<ethers.BigNumber> {
    const result = await this.call("nonces", [arg0])
    return result[0]
  }
